...
public class RdtSimulator {
    ...
    double outOfOrderRate = 0.02;            /* probability of abnormal latency */
    double lossRate = 0.02;                  /* probability of packet loss */
    double corruptRate = 0;               /* probability of packet corruption */
